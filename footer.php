...
<body>
    ...
    <div class="container py-4">
      <div class="row">
        <div class="col-1 md">
          <img src="asset\logo.png" class="logo mt-4">
        </div>
        <div class="col-xl-1 "><img src="asset\logo_jawa_barat.png" class="logo mt-4"></div>
      ...
      <div class="row mt-4">
        ...
        <div class="col-6">
          ...
          <P class="text-white">
            <a href="https://www.instagram.com/smkn4tsmofficial/" target="_blank" class="text-white text-decoration-none" >
...
Instagram
            ...
            <p class="text-white">
              <a href="https://www.tiktok.com/@smkn4tasikmalaya" target="_blank" class="text-white text-decoration-none">
